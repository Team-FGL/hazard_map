...
sub Check_latlng{
	...
	if($latlng !~ /^-{0,1}\d+\.{0,1}\d*$/){
		...
		print "\n";
		print "format error.\n";
		print "example: http://pingineer.net/cgi-bin/hazard_map/water_level.cgi?north=35.62752873025489&east=134.44981870385743&south=35.61062637667083&west=134.4089632961426\n";
		exit 0;
	}
	return $latlng;
}
