...
foreach my $kml (@file_name){
	...
	#&Read_kml_template("/mnt/small/depth5/$kml"); 
}
...
sub Check_latlng{
	...
	if($latlng !~ /^-{0,1}\d+\.{0,1}\d*$/){
		...
		print "\n";
		print "format error.\n";
		print "example: http://pingineer.net/cgi-bin/flood-map/flood-map.cgi?north=35.62752873025489&east=134.44981870385743&south=35.61062637667083&west=134.4089632961426&zoom=16&depth=5\n";
		exit 0;
	}
}
