...
function Tsunami_rank_change(value) {
  ...
  if($("input[name=tsunami_rank]:checked").val()!=1){
		return;
  }

  var rank = $("select[name=tsunami_rank]").val();
	if(rank==1){
  	Get_tsunami_area1_rank1_data();
  	Get_tsunami_area2_rank1_data();
  	Get_tsunami_area3_rank1_data();
	} else if(rank==2){
  	Get_tsunami_area1_rank1_data();
  	Get_tsunami_area2_rank1_data();
  	Get_tsunami_area3_rank1_data();
  	Get_tsunami_area1_rank2_data();
  	Get_tsunami_area2_rank2_data();
  	Get_tsunami_area3_rank2_data();
	} else if(rank==3){
  	Get_tsunami_area1_rank1_data();
  	Get_tsunami_area2_rank1_data();
  	Get_tsunami_area3_rank1_data();
  	...
  	Get_tsunami_area2_rank2_data();
  	Get_tsunami_area3_rank2_data();
  	Get_tsunami_area1_rank3_data();
  	Get_tsunami_area2_rank3_data();
  	Get_tsunami_area3_rank3_data();
	}
}

function Wide_area_change(value) {
  if($("input[name=wide_area]:checked").val()!=1){
...
function Aed_change(value) {
  if($("input[name=aed]:checked").val()!=1){
